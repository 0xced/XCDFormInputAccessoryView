...
- (instancetype) initWithResponders:(NSArray *)responders tintColor:(UIColor *)tintColor
{
    ...
    UIBarButtonItem *previousBarButtonItem = [[UIBarButtonItem alloc] initWithImage:previousImage 
                                                                landscapeImagePhone:previousLandscapeImage 
                                                                              style:UIBarButtonItemStylePlain 
                                                                             target:self 
                                                                             action:@selector(previous:)];
    self.previousBarButtonItem = previousBarButtonItem;

    UIBarButtonItem *nextBarButtonItem = [[UIBarButtonItem alloc] initWithImage:nextImage 
                                                            landscapeImagePhone:nextLandscapeImage 
                                                                          style:UIBarButtonItemStylePlain 
                                                                         target:self 
